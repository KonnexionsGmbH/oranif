/* nix command shell:
    LD_LIBRARY_PATH=priv/ ./c_src/oci_api/table_r
*/
...
int main(int argc, char *argv[])
{
	...
	char *stmt = "select test_fun(7) from dual";
	...
	/*
		MUST OCIEnvCreate(... OCI_OBJECT ...),
		Otherwise Error : ORA-21301: not initialized in object mode
	*/
